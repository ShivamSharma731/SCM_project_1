...
root.minsize(width=500,height=321)

photo = PhotoImage(file = r"C:\Users\dell1\OneDrive\Desktop\Final Project\starte.png")
photo2 = PhotoImage(file = r"C:\Users\dell1\OneDrive\Desktop\Final Project\about.png")
...
def start():
    ...
    bt2 = Button(top,text = 'CLOSE WINDOW',padx = 10, pady = 6,command = top.destroy).place(relx=0.7,rely=0.8) 
...
c = tk.Label(root,text = '           TYPING SPEED TEST  ',font=('Arial','30'),bg="#5d8aa8",fg="white")
